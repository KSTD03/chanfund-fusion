#!/usr/bin/env python3
"""
v6.5a-S_czsc-F_thsMmt-C_real-R_sl10
控制实验: sl10% 止损 + hdOnly + BULL环境
"""
...
OUT_DIR=Path(WORKSPACE)/"output/v6.5a-S_czsc-F_thsMmt-C_real-R_sl10"
...
log=logging.getLogger("v65a_sl10")
...
SLIPPAGE_BUY,SLIPPAGE_SELL=1.001,0.999; VOL_CAP_RATIO,FIXED_STOP_LOSS=0.05,0.10; FUND_SCORE_MIN=30.0
